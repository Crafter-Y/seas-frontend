      ...
      <SettingsForm>
        <View style={tw`border rounded-lg border-[${Color.DARK_GRAY}] border-2 px-2 py-1`}>
          <View style={tw`flex-row justify-between items-center`}>
            ...
            <Button color={moduleStatus?.modulePrint ? Color.RED : Color.BLUE} onPress={() => changeModuleState("print", !moduleStatus!.modulePrint)}>
        ...
        <View style={tw`border rounded-lg border-[${Color.DARK_GRAY}] border-2 px-2 py-1`}>
          <View style={tw`flex-row justify-between items-center`}>
            ...
            <Button color={moduleStatus?.moduleCalendar ? Color.RED : Color.BLUE} onPress={() => changeModuleState("calendar", !moduleStatus!.moduleCalendar)}>
              {moduleStatus?.moduleCalendar ? "Deaktivieren" : "Aktivieren"}
            </Button>
          </View>
          <Divider type="HORIZONTAL" style={tw`my-1`} />
          <Text>Fügt einen Kalenderknopf hinzu, mit welchem Kalender Exports erstellt werden können.</Text>
        </View>
      </SettingsForm>
    </SettingsLayout>
  );
